    ...
    colors: {
        ...
        secondary: {
            root: [
                ...
                "*:data-text:text-secondary hover:*:data-text:text-secondary_hover",
                // Disabled styles
        ...
        tertiary: {
            root: [
                ...
                "*:data-text:text-tertiary hover:*:data-text:text-tertiary_hover",
                // Icon styles
                "*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-quaternary_hover",
            ].join(" "),
        },
        ...
        "link-color": {
            root: [
                ...
                "*:data-text:text-brand-secondary hover:*:data-text:text-brand-secondary_hover",
                // Inner text underline
                "*:data-text:underline *:data-text:decoration-transparent *:data-text:underline-offset-2 hover:*:data-text:decoration-current",
                // Icon styles
        ...
        "secondary-destructive": {
            root: [
                ...
                "*:data-text:text-error-primary hover:*:data-text:text-error-primary_hover",
                // Disabled styles
