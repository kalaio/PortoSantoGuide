...
export const ADMIN_TITLE_CLASS = "m-0 !text-5xl leading-none text-[#12303c] max-[640px]:!text-4xl";
...
export const ADMIN_PANEL_CLASS =
  "rounded-3xl border border-[color:var(--admin-border)] bg-[var(--admin-surface)] p-6 backdrop-blur-[18px] max-[640px]:rounded-[20px] max-[640px]:p-[18px]";
...
export const ADMIN_SECTION_HEADING_CLASS = "m-0 !text-xl text-[#12303c]";

export const ADMIN_REQUIRED_LEGEND_CLASS = "mt-2 text-[color:var(--admin-muted)]";

export const ADMIN_STATUS_MESSAGE_CLASS =
  "m-0 rounded-2xl border border-[rgba(15,118,110,0.12)] bg-[rgba(15,118,110,0.08)] px-4 py-3.5 text-[color:var(--admin-muted)]";

export const ADMIN_STATUS_MESSAGE_ERROR_CLASS =
  "border-[hsla(var(--danger-h),var(--danger-s),var(--danger-l),0.12)] bg-[hsla(var(--danger-h),var(--danger-s),var(--danger-l),0.08)]";
...
export const ADMIN_TABLE_SEARCH_ICON_CLASS = "block h-4 w-4 shrink-0 text-[color:var(--admin-muted)]";
...
export const ADMIN_SIDEBAR_CLASS =
  "sticky top-0 flex min-h-screen flex-col gap-[18px] border-r border-[color:var(--admin-border)] bg-[rgba(255,255,255,0.8)] px-[18px] py-6 backdrop-blur-[18px] max-[960px]:static max-[960px]:min-h-0";

export const ADMIN_SIDEBAR_BRAND_CLASS = "grid gap-3 px-2 pt-1.5";

export const ADMIN_BRAND_LINK_CLASS = "text-[1.1rem] font-bold tracking-[0.02em] text-[#12303c]";

export const ADMIN_SIDEBAR_IDENTITY_CLASS = "grid gap-2";

export const ADMIN_SIDEBAR_USER_CLASS = "text-[0.95rem] font-semibold text-[color:var(--admin-text)]";
...
export const ADMIN_SIDEBAR_SEARCH_FIELD_CLASS =
  "flex min-h-12 items-center gap-3 rounded-2xl border border-[color:var(--admin-border)] bg-[rgba(255,255,255,0.82)] px-3.5 transition-colors duration-150 focus-within:border-[color:var(--admin-accent)]";

export const ADMIN_SIDEBAR_SEARCH_INPUT_CLASS =
  "min-w-0 flex-1 border-0 bg-transparent px-0 py-0 text-[color:var(--admin-text)] outline-none placeholder:text-[color:var(--admin-muted)]";
...
export const ADMIN_SIDEBAR_ITEM_BASE_CLASS =
  "flex min-h-11 items-center gap-3 rounded-2xl px-3.5 text-[color:var(--admin-text)] no-underline transition-colors duration-150 hover:bg-[rgba(15,118,110,0.06)]";

export const ADMIN_SIDEBAR_ITEM_ACTIVE_CLASS = "bg-[rgba(15,118,110,0.1)] text-[color:var(--admin-accent)]";

export const ADMIN_SIDEBAR_ICON_CLASS = "block h-[1.15rem] w-[1.15rem] shrink-0 text-[color:var(--admin-muted)]";

export const ADMIN_SIDEBAR_SEARCH_ICON_CLASS = "block h-4 w-4 shrink-0 text-[color:var(--admin-muted)]";

export const ADMIN_SIDEBAR_ACCORDION_CLASS = "";

export const ADMIN_SIDEBAR_ACCORDION_TRIGGER_CLASS =
  "flex min-h-[46px] w-full items-center gap-3 rounded-2xl border-0 bg-transparent px-3.5 text-left text-[color:var(--admin-text)] transition-colors duration-150 hover:bg-[rgba(15,118,110,0.06)]";

export const ADMIN_SIDEBAR_ACCORDION_TITLE_CLASS = "flex-1 leading-[1.2]";

export const ADMIN_SIDEBAR_INDICATOR_CLASS =
  "block h-4 w-4 shrink-0 text-[color:var(--admin-muted)] transition-transform duration-150";
...
export const ADMIN_SIDEBAR_SUBITEM_CLASS =
  "flex min-h-[38px] items-center gap-3 rounded-[14px] px-3.5 text-[0.94rem] text-[color:var(--admin-text)] no-underline transition-colors duration-150 hover:bg-[rgba(15,118,110,0.06)]";

export const ADMIN_SIDEBAR_EMPTY_CLASS = "px-3.5 pt-1 text-[color:var(--admin-muted)]";

export const ADMIN_SIDEBAR_FOOTER_CLASS = "mt-auto px-1";

export const ADMIN_CARD_WRAPPER_CLASS =
  "rounded-3xl border border-[color:var(--admin-border)] bg-[var(--admin-surface)] backdrop-blur-[18px] max-[640px]:rounded-[20px]";
...
export const ADMIN_CARD_TITLE_CLASS = "!text-lg font-bold text-[#12303c]";

export const ADMIN_CARD_DESCRIPTION_CLASS = "m-0 text-[color:var(--admin-muted)]";

export const ADMIN_CARD_BODY_CLASS = "grid gap-[18px] p-6 pt-[18px]";

export const ADMIN_FORM_SECTION_CLASS =
  "grid gap-4 rounded-[20px] border border-[color:var(--admin-border)] bg-[var(--admin-surface)] p-[18px] backdrop-blur-[18px] max-[640px]:rounded-[20px] max-[640px]:p-[18px]";
...
export const ADMIN_FIELD_LABEL_CLASS = "text-[0.95rem] font-semibold text-[color:var(--admin-text)]";

export const ADMIN_FIELD_REQUIRED_CLASS = "text-[color:var(--danger)]";

export const ADMIN_FIELD_HINT_CLASS = "text-[0.8rem] text-[color:var(--admin-muted)]";

export const ADMIN_FIELD_ERROR_CLASS = "m-0 text-[0.84rem] text-[color:var(--danger)]";

export const ADMIN_CHECKBOX_LABEL_MUTED_CLASS = "text-[color:var(--admin-muted)]";

export const ADMIN_INPUT_CLASS = "w-full";

export const ADMIN_INPUT_WRAPPER_CLASS =
  "border-[color:var(--admin-border)] bg-[rgba(255,255,255,0.82)] !shadow-none transition-colors data-[hover=true]:border-[rgba(15,118,110,0.28)] group-data-[focus=true]:border-[color:var(--admin-accent)]";
...
export const ADMIN_SELECT_TRIGGER_CLASS =
  "border-[color:var(--admin-border)] bg-[rgba(255,255,255,0.82)] !shadow-none transition-colors data-[hover=true]:border-[rgba(15,118,110,0.28)] data-[open=true]:border-[color:var(--admin-accent)] data-[focus=true]:border-[color:var(--admin-accent)]";

export const ADMIN_SELECT_VALUE_CLASS = "text-[color:var(--admin-text)]";
...
export const ADMIN_BUTTON_PRIMARY_CLASS =
  "bg-[color:var(--admin-accent)] text-white hover:bg-[color:var(--admin-accent)]/90";

export const ADMIN_BUTTON_SECONDARY_CLASS =
  "border border-[color:var(--admin-border)] bg-transparent text-[color:var(--admin-text)] hover:bg-black/5";

export const ADMIN_BUTTON_DANGER_CLASS = "bg-[color:var(--danger)] text-white hover:bg-[color:var(--danger)]/90";

export const ADMIN_BUTTON_GHOST_CLASS = "bg-transparent text-[color:var(--admin-text)] hover:bg-black/5";
...
export const ADMIN_MENU_CARD_CLASS =
  "min-h-full transition duration-150 hover:-translate-y-px hover:border-[rgba(15,118,110,0.22)] focus-visible:-translate-y-px focus-visible:border-[rgba(15,118,110,0.22)]";
...
export const ADMIN_SECTION_TITLE_CLASS = "mt-2 !text-base text-[color:var(--admin-text)]";

export const ADMIN_LIST_LINK_CLASS = "block text-inherit no-underline outline-none";

export const ADMIN_LIST_ITEM_CLASS =
  "cursor-pointer rounded-[18px] border border-[rgba(15,23,42,0.08)] bg-[rgba(255,255,255,0.72)] p-4 transition duration-150 hover:-translate-y-px hover:border-[rgba(15,118,110,0.28)] focus-visible:-translate-y-px focus-visible:border-[rgba(15,118,110,0.28)] focus-visible:outline-none";

export const ADMIN_LIST_ITEM_ACTIVE_CLASS = "border-[rgba(15,118,110,0.28)] -translate-y-px";
...
export const ADMIN_SCOPE_BADGE_CLASS =
  "inline-flex min-h-[30px] items-center justify-center whitespace-nowrap rounded-full bg-[rgba(15,118,110,0.1)] px-2.5 text-[0.78rem] font-bold tracking-[0.01em] text-[color:var(--admin-accent)]";

export const ADMIN_FIELD_REGISTRY_LIST_CLASS = "grid gap-[14px]";

export const ADMIN_FIELD_REGISTRY_LIST_INVALID_CLASS =
  "rounded-[18px] border border-[hsla(var(--danger-h),var(--danger-s),var(--danger-l),0.22)] p-[14px]";
...
export const ADMIN_DRAFT_CHIP_CLASS = "bg-[rgba(15,118,110,0.12)] text-[color:var(--admin-accent)]";

export const ADMIN_SLIDE_UPLOAD_FIELD_CLASS =
  "grid min-w-0 gap-3 rounded-[20px] border border-[rgba(15,23,42,0.08)] bg-[rgba(255,255,255,0.72)] p-4";

export const ADMIN_SLIDE_UPLOAD_HEADER_CLASS = "flex flex-wrap items-baseline justify-between gap-3";

export const ADMIN_SLIDE_UPLOAD_HINT_CLASS = "text-[color:var(--admin-muted)]";

export const ADMIN_SLIDE_UPLOAD_TRIGGER_CLASS = "w-full";

export const ADMIN_SLIDE_UPLOAD_META_CLASS = "m-0 text-[color:var(--admin-muted)]";
...
export const ADMIN_SLIDE_PREVIEW_PLACEHOLDER_CLASS = "text-[0.92rem] text-[color:var(--admin-text)]";
...
export const ADMIN_HOURS_INTERVAL_SEPARATOR_CLASS = "justify-self-center text-[color:var(--admin-muted)]";

export const ADMIN_HOURS_SECTION_CLASS = "grid gap-3";

export const ADMIN_HOURS_TITLE_CLASS = "mt-2 text-[color:var(--admin-text)]";

export const ADMIN_MAP_BLOCK_CLASS = "grid gap-4";

export const ADMIN_MAP_PICKER_CLASS = "min-h-[300px] overflow-hidden rounded-[22px] border border-[color:var(--admin-border)]";

export const ADMIN_MAP_INVALID_CLASS = "border-[hsla(var(--danger-h),var(--danger-s),var(--danger-l),0.22)]";

export const ADMIN_MAP_NOTE_CLASS = "m-0 text-[color:var(--admin-muted)]";
...
export const ADMIN_CATEGORY_ICON_PREVIEW_CLASS =
  "grid h-[52px] w-[52px] place-items-center rounded-[18px] border border-[rgba(15,23,42,0.08)] bg-[rgba(255,255,255,0.72)] text-[color:var(--admin-accent)]";

export const ADMIN_CUISINE_SELECT_VALUE_CLASS =
  "block min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-[color:var(--admin-text)]";

export const ADMIN_CUISINE_SELECT_VALUE_PLACEHOLDER_CLASS = "text-[color:var(--admin-muted)]";
...
export const ADMIN_TIME_INPUT_SEGMENT_CLASS = "text-[color:var(--admin-text)]";
