    ...
    <main className="mx-auto w-full max-w-[1280px] px-4 pt-4 pb-6 md:px-5 md:pt-6 md:pb-10">
      <section className="mb-8 grid gap-3 max-[640px]:mb-6">
        ...
        <ExpandableDescription
          ...
          text="Plan your day with guided activities, scenic stops, and local experiences."
        />
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {section.categories.map((category) => (
          ...
          >
            ...
            <strong className="inline-flex items-center gap-3 text-lg font-semibold text-black">
              <span>{category.label}</span>
            </strong>
            <p className="text-md text-[color:var(--psg-text-secondary)]">{category.listingCount} places</p>
          </Link>
        ))}
      </section>
    </main>
