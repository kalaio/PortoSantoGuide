    ...
    <div className="grid gap-5">
      ...
      >
        ...
        {showMap ? (
          <div
            className={cn(
              "min-h-[44rem] overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm max-[900px]:min-h-[50vh] max-[900px]:hidden",
              isMobileMapMode && "fixed inset-x-0 bottom-0 top-[7.6rem] z-20 block rounded-none border-x-0 border-b-0",
